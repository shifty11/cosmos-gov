...
func (tcq *TelegramChatQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64
...
func (tcq *TelegramChatQuery) GroupBy(field string, fields ...string) *TelegramChatGroupBy {
	group := &TelegramChatGroupBy{config: tcq.config}
...
func (tcq *TelegramChatQuery) Select(fields ...string) *TelegramChatSelect {
	...
	return &TelegramChatSelect{TelegramChatQuery: tcq}
}
...
func (tcq *TelegramChatQuery) sqlAll(ctx context.Context) ([]*TelegramChat, error) {
	var (
		nodes       = []*TelegramChat{}
		withFKs     = tcq.withFKs
		_spec       = tcq.querySpec()
	...
	if query := tcq.withUser; query != nil {
		...
		nodeids := make(map[int64][]*TelegramChat)
		for i := range nodes {
	...
	if query := tcq.withChains; query != nil {
		...
		query.Where(predicate.Chain(func(s *sql.Selector) {
			s.Where(sql.InValues(telegramchat.ChainsColumn, fks...))
		}))
		neighbors, err := query.All(ctx)
		if err != nil {
			return nil, err
		...
		for _, n := range neighbors {
			fk := n.telegram_chat_chains
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "telegram_chat_chains" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "telegram_chat_chains" returned %v for node %v`, *fk, n.ID)
			}
...
func (tcgb *TelegramChatGroupBy) ScanX(ctx context.Context, v interface{}) {
...
func (tcgb *TelegramChatGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(tcgb.fields) > 1 {
		return nil, errors.New("ent: TelegramChatGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := tcgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tcgb *TelegramChatGroupBy) StringsX(ctx context.Context) []string {
...
// It is only allowed when executing a group-by query with one field.
func (tcgb *TelegramChatGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{telegramchat.Label}
	default:
		err = fmt.Errorf("ent: TelegramChatGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (tcgb *TelegramChatGroupBy) StringX(ctx context.Context) string {
...
// It is only allowed when executing a group-by query with one field.
func (tcgb *TelegramChatGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(tcgb.fields) > 1 {
		return nil, errors.New("ent: TelegramChatGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := tcgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tcgb *TelegramChatGroupBy) IntsX(ctx context.Context) []int {
	v, err := tcgb.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (tcgb *TelegramChatGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{telegramchat.Label}
	default:
		err = fmt.Errorf("ent: TelegramChatGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (tcgb *TelegramChatGroupBy) IntX(ctx context.Context) int {
	v, err := tcgb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (tcgb *TelegramChatGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(tcgb.fields) > 1 {
		return nil, errors.New("ent: TelegramChatGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := tcgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tcgb *TelegramChatGroupBy) Float64sX(ctx context.Context) []float64 {
...
// It is only allowed when executing a group-by query with one field.
func (tcgb *TelegramChatGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{telegramchat.Label}
	default:
		err = fmt.Errorf("ent: TelegramChatGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (tcgb *TelegramChatGroupBy) Float64X(ctx context.Context) float64 {
...
// It is only allowed when executing a group-by query with one field.
func (tcgb *TelegramChatGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(tcgb.fields) > 1 {
		return nil, errors.New("ent: TelegramChatGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := tcgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tcgb *TelegramChatGroupBy) BoolsX(ctx context.Context) []bool {
...
// It is only allowed when executing a group-by query with one field.
func (tcgb *TelegramChatGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{telegramchat.Label}
	default:
		err = fmt.Errorf("ent: TelegramChatGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (tcgb *TelegramChatGroupBy) BoolX(ctx context.Context) bool {
	v, err := tcgb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
// ScanX is like Scan, but panics if an error occurs.
func (tcs *TelegramChatSelect) ScanX(ctx context.Context, v interface{}) {
...
func (tcs *TelegramChatSelect) Strings(ctx context.Context) ([]string, error) {
	if len(tcs.fields) > 1 {
		return nil, errors.New("ent: TelegramChatSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := tcs.Scan(ctx, &v); err != nil {
		return nil, err
...
// StringsX is like Strings, but panics if an error occurs.
func (tcs *TelegramChatSelect) StringsX(ctx context.Context) []string {
...
func (tcs *TelegramChatSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{telegramchat.Label}
	default:
		err = fmt.Errorf("ent: TelegramChatSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (tcs *TelegramChatSelect) StringX(ctx context.Context) string {
...
func (tcs *TelegramChatSelect) Ints(ctx context.Context) ([]int, error) {
	if len(tcs.fields) > 1 {
		return nil, errors.New("ent: TelegramChatSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := tcs.Scan(ctx, &v); err != nil {
		return nil, err
...
// IntsX is like Ints, but panics if an error occurs.
func (tcs *TelegramChatSelect) IntsX(ctx context.Context) []int {
	v, err := tcs.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
func (tcs *TelegramChatSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{telegramchat.Label}
	default:
		err = fmt.Errorf("ent: TelegramChatSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (tcs *TelegramChatSelect) IntX(ctx context.Context) int {
	v, err := tcs.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (tcs *TelegramChatSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(tcs.fields) > 1 {
		return nil, errors.New("ent: TelegramChatSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := tcs.Scan(ctx, &v); err != nil {
		return nil, err
...
// Float64sX is like Float64s, but panics if an error occurs.
func (tcs *TelegramChatSelect) Float64sX(ctx context.Context) []float64 {
...
func (tcs *TelegramChatSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{telegramchat.Label}
	default:
		err = fmt.Errorf("ent: TelegramChatSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (tcs *TelegramChatSelect) Float64X(ctx context.Context) float64 {
...
func (tcs *TelegramChatSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(tcs.fields) > 1 {
		return nil, errors.New("ent: TelegramChatSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := tcs.Scan(ctx, &v); err != nil {
		return nil, err
...
// BoolsX is like Bools, but panics if an error occurs.
func (tcs *TelegramChatSelect) BoolsX(ctx context.Context) []bool {
	v, err := tcs.Bools(ctx)
	if err != nil {
		panic(err)
	}
...
func (tcs *TelegramChatSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{telegramchat.Label}
	default:
		err = fmt.Errorf("ent: TelegramChatSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (tcs *TelegramChatSelect) BoolX(ctx context.Context) bool {
	v, err := tcs.Bool(ctx)
	if err != nil {
		panic(err)
	}
